...
{
    public ItemDesynthSourceRenderer(ITextureProvider iTextureProvider)
        : base(
        iTextureProvider,
        ItemInfoType.Desynthesis,
        Icons.DesynthesisIcon)
    {
    }
...
{
    public ItemReductionSourceRenderer(ITextureProvider iTextureProvider)
        : base(
        iTextureProvider,
...
{
    public ItemLootSourceRenderer(ITextureProvider iTextureProvider)
        : base(
        iTextureProvider,
        ItemInfoType.Loot,
        Icons.LootIcon)
    ...
    public override string HelpText =>
        "Can the item be obtained from another item(normally a chest/material container/coffer)?";
}

public class ItemGardeningSourceRenderer : ItemSupplementSourceRenderer<ItemGardeningSource>
{
    public ItemGardeningSourceRenderer(ITextureProvider iTextureProvider)
        : base(
        iTextureProvider,
...
{
    public ItemDesynthUseRenderer(ITextureProvider iTextureProvider)
        : base(
        iTextureProvider,
        ItemInfoType.Desynthesis,
        Icons.DesynthesisIcon)
...
{
    public ItemReductionUseRenderer(ITextureProvider iTextureProvider)
        : base(
        iTextureProvider,
        ItemInfoType.Reduction,
        Icons.ReductionIcon)
...
{
    public ItemLootUseRenderer(ITextureProvider iTextureProvider)
        : base(
        iTextureProvider,
        ItemInfoType.Loot,
        Icons.LootIcon)
...
{
    public ItemGardeningUseRenderer(ITextureProvider iTextureProvider)
        : base(
        iTextureProvider,
        ItemInfoType.Gardening,
        Icons.SproutIcon)
...
{
    public ItemCardPackSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.CardPack,
        Icons.CardPackIcon)
    {
    }
...
{
    public ItemCardPackUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.CardPack,
        Icons.CardPackIcon)
...
{
    public ItemCofferSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Coffer,
        Icons.CofferIcon)
...
{
    public ItemCofferUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Coffer,
        Icons.CofferIcon)
...
{
    public ItemPalaceOfTheDeadSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.PalaceOfTheDead,
        Icons.DeepDungeonIcon)
    {
    }
...
{
    public ItemPalaceOfTheDeadUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.PalaceOfTheDead,
        Icons.DeepDungeonIcon)
...
{
    public ItemHeavenOnHighSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
...
{
    public ItemHeavenOnHighUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.HeavenOnHigh,
        Icons.DeepDungeonIcon)
...
{
    public ItemEurekaOrthosSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
...
{
    public ItemEurekaOrthosUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.EurekaOrthos,
        Icons.DeepDungeonIcon)
...
{
    public ItemAnemosSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Anemos,
        Icons.FieldOpsIcon)
...
{
    public ItemAnemosUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Anemos,
        Icons.FieldOpsIcon)
...
{
    public ItemPagosSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Pagos,
        Icons.FieldOpsIcon)
...
{
    public ItemPagosUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Pagos,
        Icons.FieldOpsIcon)
...
{
    public ItemPyrosSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Pyros,
        Icons.FieldOpsIcon)
...
{
    public ItemPyrosUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Pyros,
        Icons.FieldOpsIcon)
...
{
    public ItemHydatosSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
...
{
    public ItemHydatosUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Hydatos,
        Icons.FieldOpsIcon)
...
{
    public ItemBozjaSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Bozja,
        Icons.FieldOpsIcon)
...
{
    public ItemBozjaUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Bozja,
        Icons.FieldOpsIcon)
...
{
    public ItemLogogramSourceRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
...
{
    public ItemLogogramUseRenderer(ITextureProvider textureProvider)
        : base(
        textureProvider,
        ItemInfoType.Logogram,
        Icons.FieldOpsIcon)
    ...
    public override Func<ItemSource, int> GetIcon => source => { return source.CostItem!.Icon; };
}

public class ItemPilgrimsTraverseSourceRenderer : ItemSupplementSourceRenderer<ItemPilgrimsTraverseSource>
{
    public ItemPilgrimsTraverseSourceRenderer(ITextureProvider textureProvider)
        : base(textureProvider, ItemInfoType.PilgrimsTraverse, Icons.FieldOpsIcon)
    {
    }
...
{
    public ItemOizysSourceRenderer(ITextureProvider textureProvider)
        : base(textureProvider, ItemInfoType.Oizys, Icons.FieldOpsIcon)
    {
    }
...
public abstract class ItemSupplementUseRenderer<T> : ItemSupplementSourceRenderer<T>
    where T : ItemSupplementSource
{
    protected ItemSupplementUseRenderer(ITextureProvider iTextureProvider, ItemInfoType itemInfoType, ushort icon)
        : base(iTextureProvider, itemInfoType, icon)
    {
    }
    ...
    public override Action<List<ItemSource>>? DrawTooltipGrouped => sources =>
    {
        ...
        {
            ImGui.Image(
                this.TextureProvider.GetFromGameIcon(new GameIconLookup(source.Item.Icon)).GetWrapOrEmpty().Handle,
...
public abstract class ItemSupplementSourceRenderer<T> : ItemInfoRenderer<T>
    where T : ItemSupplementSource
{
    ...
    public override Action<List<ItemSource>>? DrawTooltipGrouped => sources =>
    {
        ...
        {
            ImGui.Image(
                this.TextureProvider.GetFromGameIcon(new GameIconLookup(source.CostItem!.Icon)).GetWrapOrEmpty().Handle,
                new Vector2(18, 18) * ImGui.GetIO().FontGlobalScale);
            ImGui.SameLine();
    ...
    public override Func<ItemSource, string> GetName => _ => string.Empty;
}
