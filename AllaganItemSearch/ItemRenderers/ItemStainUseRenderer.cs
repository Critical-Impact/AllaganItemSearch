...
public class ItemStainUseRenderer : ItemInfoRenderer<ItemStainSource>
{
    ...
    public override Action<ItemSource> DrawTooltip => source =>
    {
        ...
        if (ImGui.ColorButton("ColorPreview", color, ImGuiColorEditFlags.None, new Vector2(64, 64)))
        {
        }
    };
    ...
    public override Func<ItemSource, int> GetIcon => source => { return Icons.DyeIcon; };
}
